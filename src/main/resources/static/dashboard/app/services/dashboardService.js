            ...
            var myInterceptor = {
                ...
                'response': function(response) {
                    if (response.config) {
                        ...
                        console.log('AngularDB.Ajax ' + 'url:' + response.config.url + ' timeTakenInMs:' + timeTakenInMs + ' status:' + response.status);
                    }
                    return response;
                },
                'responseError': function(rejection) {
                    var errorMessage = "timeout";
                    if (rejection.status != 0 && rejection.data) {
                    ...
                    console.log('AngularDB.AjaxError ' + 'errorMessage:' + errorMessage + ' status:' + rejection.status);
...
.factory('msgBus', ['$rootScope', 'socketService',
